...
export default function ProjectDetail() {
  ...
  const shouldShowBehance =
    project.behanceLink &&
    project.behanceLink.trim() !== "" &&
    project.behanceLink !== "#";
    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative min-h-[70vh] flex items-end pb-16">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div
            className={`absolute inset-0 bg-gradient-to-r ${project.accentColor} opacity-20`}
          />
        </div>
        ...
        <div
          className="absolute bottom-1/3 left-1/4 w-48 h-48 bg-accent/20 rounded-full blur-3xl animate-pulse"
        ...
        <div className="container relative z-10">
          <ScrollReveal animation="fade-up">
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${project.accentColor} text-white mb-6`}
            >
              <Sparkles className="w-4 h-4" />
              <span className="text-sm font-semibold">{project.category}</span>
            </div>
            <h1
              className={`text-5xl lg:text-7xl font-display font-bold mb-4 bg-gradient-to-r ${project.accentColor} bg-clip-text text-transparent`}
            >
              {project.title}
            </h1>
          ...
          <ScrollReveal animation="fade-up">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={label}
                  className="p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/30 transition-all duration-300 group"
                >
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${project.accentColor} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="fade-left">
              <div
                className={`relative p-8 rounded-3xl bg-gradient-to-br ${project.accentColor} overflow-hidden`}
              >
                  ...
                  <div className="space-y-4">
                    {project.features.map((feature, i) => (
                      <div key={i} className="flex items-start gap-3">
                        <div
                          className={`w-8 h-8 rounded-full bg-gradient-to-r ${project.accentColor} flex items-center justify-center flex-shrink-0`}
                        >
      ...
      {shouldShowBehance && (
        <section className="py-20">
          <div className="container">
            <ScrollReveal animation="zoom-in">
              <div
                className={`relative p-12 rounded-3xl bg-gradient-to-r ${project.accentColor} overflow-hidden text-center`}
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <p className="text-white/80 max-w-xl mx-auto">
                    Explore the complete design process, research insights, and
                    detailed solutions on Behance.
                  </p>
                  <p className="text-white/60 text-sm max-w-md mx-auto italic">
                    Note: If you are in Syria, you will need a VPN to access
                    Behance.
                  </p>
                  <a
